# Cosa è un chlorpleth ?

## A cosa serve
- Visualizzare distribuzioni geografche di dati statistici
- Confrontare aree sullo stesso indicatore (densità, tasso, percentuale, . . . )
- Identifcare pattern spaziali: cluster, gradienti, anomalie
...
| ggplot 2       | visualizzazione, mappe via geom_sf() |
| tmaap          | mappe tematiche, statiche e interattive |
| leaflet        | mappe interattive in HTML |

## Link
Per approfnodire: r-spatial.org.
